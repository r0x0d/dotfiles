-- ptyxis.lua — colorscheme based on the GNOME Ptyxis terminal palette (dark)

vim.cmd("highlight clear")
if vim.fn.exists("syntax_on") then
    vim.cmd("syntax reset")
end
vim.g.colors_name = "ptyxis"
vim.o.background = "dark"

-- stylua: ignore start
local p = {
    -- Base (from Ptyxis GNOME Dark palette)
    bg        = '#1c1c1f',
    bg_dark   = '#161618',
    bg_float  = '#222225',
    bg_line   = '#28282c',
    ...
    -- Foreground
    fg        = '#c0bfbc',   -- Color7
    fg_bright = '#f6f5f4',   -- Color15
    fg_dim    = '#5e5c64',   -- Color8
    fg_dark   = '#46444c',

    -- Syntax (GNOME ANSI dark palette)
    blue      = '#51a1ff',   -- Color12
    cyan      = '#4fd2fd',   -- Color14
    green     = '#57e389',   -- Color10
    yellow    = '#f5c211',   -- Color3
    orange    = '#e5a32e',   -- derived warm amber
    red       = '#ed333b',   -- Color9
    magenta   = '#c061cb',   -- Color13
    teal      = '#0ab9dc',   -- Color6
    peach     = '#c49060',   -- derived warm brown
    pink      = '#d56e8f',   -- derived soft pink
    ...
    match     = '#51a1ff',
    added     = '#2ec27e',   -- Color2
    changed   = '#f5c211',   -- Color3
    removed   = '#c01c28',   -- Color1
    error     = '#ed333b',   -- Color9
    warn      = '#f5c211',   -- Color3
    info      = '#51a1ff',   -- Color12
    hint      = '#2ec27e',   -- Color2
...
hi("DiffAdd",      { bg = '#222e28' })
hi("DiffChange",   { bg = '#222530' })
hi("DiffDelete",   { fg = p.removed, bg = '#302225' })
hi("DiffText",     { bg = '#2a3040' })
...
hi("@comment.error",        { fg = p.red, bg = '#302020', bold = true })
hi("@comment.warning",      { fg = p.yellow, bg = '#302a15', bold = true })
...
hi("DiagnosticVirtualTextError", { fg = p.error, bg = '#302020' })
hi("DiagnosticVirtualTextWarn",  { fg = p.warn, bg = '#302a15' })
hi("DiagnosticVirtualTextInfo",  { fg = p.info, bg = '#1e2835' })
hi("DiagnosticVirtualTextHint",  { fg = p.hint, bg = '#1e3028' })
...
hi("GitSignsAddLn",        { bg = '#222e28' })
hi("GitSignsChangeLn",     { bg = '#222530' })
hi("GitSignsDeleteLn",     { bg = '#302225' })
...
hi("RenderMarkdownH1Bg", { bg = '#242838', bold = true })
hi("RenderMarkdownH2Bg", { bg = '#242e35', bold = true })
hi("RenderMarkdownH3Bg", { bg = '#242e28', bold = true })
hi("RenderMarkdownH4Bg", { bg = '#2e2438', bold = true })
hi("RenderMarkdownH5Bg", { bg = '#2e2820', bold = true })
hi("RenderMarkdownH6Bg", { bg = '#242e2a', bold = true })
