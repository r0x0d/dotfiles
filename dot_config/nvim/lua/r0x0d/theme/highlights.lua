...
function M.setup()
    ...
    hi {
        ...
        TelescopePromptNormal = { fg = p.fg, bg = p.bg_surface },
        TelescopePromptBorder = { fg = p.border_light, bg = p.bg_surface },
        TelescopePromptTitle = { fg = p.light1, bg = p.accent_strong, bold = true },
        ...
        TelescopeResultsTitle = { fg = p.fg_dim, bg = p.bg_float },

        TelescopePreviewNormal = { fg = p.fg, bg = p.bg },
        TelescopePreviewBorder = { fg = p.border_light, bg = p.bg },
        TelescopePreviewTitle = { fg = p.light1, bg = p.success, bold = true },
